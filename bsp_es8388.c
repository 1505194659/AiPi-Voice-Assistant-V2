...
void ES8388_Playback_Mode(ES8388_Cfg_Type *cfg)
{
    ...
    ES8388_Write_Reg(0x1A, 0x0C); //LDAC volume = -6dB (reduced from 0dB to prevent clipping)
    ES8388_Write_Reg(0x1B, 0x0C); //RDAC volume = -6dB (reduced from 0dB to prevent clipping)
    ...
    ES8388_Write_Reg(0x2E, 0x18); //Set Lout/Rout volume: -3dB (reduced from 0dB)
    ES8388_Write_Reg(0x2F, 0x18); //Set Lout/Rout volume: -3dB
    ES8388_Write_Reg(0x30, 0x18); //Set Lout/Rout volume: -3dB
    ES8388_Write_Reg(0x31, 0x18); //Set Lout/Rout volume: -3dB
